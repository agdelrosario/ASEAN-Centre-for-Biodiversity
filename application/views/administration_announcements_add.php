...
echo heading('Administration &rarr; Announcement &rarr; Add', 1, "class=\"administration\"");
...
echo "<p><strong>Notice:</strong> All newly-added announcements are inactive by default.</p>";

echo validation_errors();

echo form_open("administration/announcements/add", array("id" => "myform"));
	echo form_fieldset("Announcement");
		echo $this->table->add_row("Announcement:", form_input("announcement", ""));
